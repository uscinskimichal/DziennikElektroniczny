...
import src.utilities.data.Absence;
import javafx.application.Platform;
import javafx.stage.Stage;
import src.controller.LoginWindowController;
import src.utilities.data.Note;
import src.utilities.data.Message;
import src.utilities.data.Schedule;
...
public class Database {
    ...
    static public void connectToTheDatabase() {
        ...
        try {
            ...
            String user = ResourceBundle.getBundle("resources.boundles.database").getString("DatabaseUser");
            String password = ResourceBundle.getBundle("resources.boundles.database").getString("DatabasePassword");
            connection = DriverManager.getConnection(ResourceBundle.getBundle("resources.boundles.database").getString("DatabaseAddress"), user, password);
