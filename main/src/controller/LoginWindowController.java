...
import src.utilities.connectionChecker.ConnectionChecker;
...
public class LoginWindowController extends Navigator {
    ...
    private void popPleaseWait() {
        ...
        changeScene("/resources/fxml/PleaseWait.fxml", getResourceBundle().getString("PleaseWaitTitle"), pleaseWaitWindow);
